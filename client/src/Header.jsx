...
export default function Header() {
  ...
  if (!ready) {
    return null; // Or show a loader until user data is ready
  }
  return (
    <header className=" flex justify-between">
      ...
      <Link
        ...
        className="flex items-center gap-2 border border-gray-500 rounded-full py-2 px-4 shadow-md shadow-gray-150"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          fill="none"
